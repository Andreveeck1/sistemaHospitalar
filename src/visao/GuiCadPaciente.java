...
public class GuiCadPaciente extends javax.swing.JInternalFrame {
    ...
    public GuiCadPaciente() {
        ...
        Connection conexao = pacDao.criaConexaoComBancoDados();
        preencherCombo(conexao);
    }
    ...
    private void cadastrar() {
        try {
            ...
            if (!(jcConvenio.getSelectedIndex() == 0)) {
                ...
                Connection conexao = convDAO.criaConexaoComBancoDados();
                Convenio convenio = convDAO.buscarConvenioFiltro(conv,conexao);
    ...
    private void preencherCombo(Connection conexao) {
        try {
            ...
            ArrayList<Convenio> p = new ArrayList<>();
             ...
             conexao = convDAO.criaConexaoComBancoDados();

            // Recebendo o ArrayList cheio em produtos
            p = ps.buscarConvenio(conexao);
